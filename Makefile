...
#    Updated: 2023/03/26 19:26:10 by russelenc        ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = test.c so_long.c ft_check_file_format.c ft_check_map.c ft_check_map_utils.c \
		ft_get_map.c get_next_line.c get_next_line_utils.c
